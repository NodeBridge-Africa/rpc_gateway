...
import DefaultAppSettings, {
  IDefaultAppSettings,
} from "../models/defaultAppSettings.model";
...
export class DefaultAppSettingsController {
    ...
    try {
      ...
      if (!settings) {
        ...
        successResponse(res, 200, {
          message: "Default app settings retrieved (initial defaults created).",
          settings,
        });
        return;
      }
      successResponse(res, 200, {
        message: "Default app settings retrieved successfully.",
        settings,
      });
    } catch (error) {
  ...
  public async updateDefaultAppSettings(
    ...
    try {
      ...
      if (
        typeof defaultMaxRps !== "number" ||
        typeof defaultDailyRequestsLimit !== "number"
      ) {
      ...
      successResponse(res, 200, {
        message: "Default app settings updated successfully.",
